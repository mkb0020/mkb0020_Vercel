...
@app.route("/tiktok-developers-site-verification=fK9VSO1hXzWcNVMzyhZpd66p8XLZScLW", strict_slashes=False)
def tiktok_verify():
    return "tiktok-developers-site-verification=fK9VSO1hXzWcNVMzyhZpd66p8XLZScLW"
